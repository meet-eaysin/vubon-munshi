...
export const TextareaWithStatus: React.FC<TextareaWithStatusProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`absolute top-0 left-0 h-1 transition-all duration-500 ease-out ${progressBarWidth > 0 ? 'opacity-100' : 'opacity-0'
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              <span
                ...
                className={`text-xs font-medium px-1.5 py-0.5 rounded-full ${characterCount < minCharacters ? "bg-destructive/10 ring-1 ring-destructive/20" :
